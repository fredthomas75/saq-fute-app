export const fr = {
  ...
  camera: {
    ...
    notFoundSAQ: 'Non disponible à la SAQ',
    notFoundSAQSub: 'Ce vin ne semble pas être vendu à la SAQ. Vous pouvez consulter le Sommelier IA pour en savoir plus sur ce vin.',
    askSommelier: 'Demander au Sommelier IA',
    retry: 'Réessayer',
