...
export const en: typeof fr = {
  ...
  camera: {
    ...
    webScanHint: 'Point the barcode at the camera',
    manualTitle: 'Enter barcode',
    manualPlaceholder: 'E.g.: 5603016000221',
    manualSubmit: 'Search',
    manualEntry: 'Enter code manually',
    webScanning: 'Scanning...',
    webNoDetector: 'Scanner not available \u2014 enter the code manually',
    webScanError: 'Scanner error \u2014 enter the code manually',
